          ...
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              <Link to="/dashboard"> 
                ...
                <span>{props.t("Dashboard")}</span></Link>
            </li>
            <li>
              <Link to="/customer"> 
                <i className="bx bx-user"></i>
                <span>{props.t("Customer")}</span></Link>
            </li>
            <li>
              <Link to="/claims"> 
                <i className="bx bx-receipt"></i>
                <span>{props.t("Claims")}</span></Link>
            </li>
            <li>
              <Link to="/policies"> 
                <i className="bx bx-file"></i>
                <span>{props.t("Policies")}</span></Link>
            </li>
            <li>
              <Link to="/endorsement"> 
                <i className="bx bx-brightness"></i>
                <span>{props.t("Endorsement")}</span></Link>
            </li>
            <li>
              <Link to="/statement"> 
                <i className="bx bx-detail"></i>
                <span>{props.t("Commision statement")}</span></Link>
            </li> 
           {/*  */}
